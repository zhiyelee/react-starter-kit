...
/***/ function(module, exports, __webpack_require__) {
	...
	var $__0=  __webpack_require__(6),Router=$__0.Router;
	...
	var routes = {
	  '/react-starter-kit/': function()  {return render(HomePage);},
	  '/react-starter-kit/privacy': function()  {return render(__webpack_require__(4));}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $__0=  __webpack_require__(13),Dispatcher=$__0.Dispatcher;
	var PayloadSources = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(5);
	var DefaultLayout = __webpack_require__(7);
	          ...
	          React.DOM.div({className: "row"}, 
	            React.DOM.div({className: "col-sm-4"}, 
	              ...
	              React.DOM.dl(null, 
	                ...
	                React.DOM.dt(null, React.DOM.a({href: "https://github.com/flatiron/director"}, "Director")), 
	                React.DOM.dd(null, "A tiny and isomorphic URL router for JavaScript"), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var listener = {
	  ...
	  setHash: function (s) {
	    ...
	    if (this.history === true) {
	      ...
	      dloc.hash = (s[0] === '/react-starter-kit/') ? s : '/react-starter-kit/' + s;
	    }
	    return this;
	  },
	...
	Router.prototype.init = function (r) {
	  ...
	  this.handler = function(onChangeEvent) {
	    ...
	    self.dispatch('on', url.charAt(0) === '/react-starter-kit/' ? url : '/react-starter-kit/' + url);
	  };
	  ...
	  if (this.history === false) {
	    if (dlocHashEmpty() && r) {
	      ...
	      self.dispatch('on', '/react-starter-kit/' + dloc.hash.replace(/^(#\/|#|\/)/, ''));
	    }
	  }
	  else {
	...
	Router.prototype.explode = function () {
	  ...
	  if (v.charAt(1) === '/react-starter-kit/') { v=v.slice(1) }
	  return v.slice(1, v.length).split("/react-starter-kit/");
	};
	...
	Router.prototype.setRoute = function (i, v, val) {
	  ...
	  listener.setHash(url.join('/react-starter-kit/'));
	  return url;
	};
	...
	Router.prototype.getPath = function () {
	  ...
	  if (path.substr(0, 1) !== '/react-starter-kit/') {
	    path = '/react-starter-kit/' + path;
	  }
	  return path;
	};
	...
	Router.prototype.configure = function(options) {
	  ...
	  this.delimiter = options.delimiter || "/react-starter-kit/";
	...
	Router.prototype.on = Router.prototype.route = function(method, path, route) {
	  ...
	  if (path.source) {
	    path = path.source.replace(/\\\//ig, "/react-starter-kit/");
	  }
	        ...
	        React.DOM.div({className: "navbar-footer"}, 
	          React.DOM.div({className: "container"}, 
	            React.DOM.p({className: "text-muted"}, 
	              ' © KriaSoft • ', 
	              Link({to: "/react-starter-kit/"}, "Home"), ' • ', 
	              Link({to: "/react-starter-kit/privacy"}, "Privacy")
	            )
	          )
	        )
	      )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(5);
	var RouteActions = __webpack_require__(35);
	...
	var Link = React.createClass({displayName: 'Link',
	  ...
	  render:function() {
	    this.props.href =
	      this.props.to && this.props.to.lastIndexOf('/react-starter-kit/', 0) === 0 ?
	      this.props.to : '/react-starter-kit/' + this.props.to;

	    return this.transferPropsTo(
	      React.DOM.a({onClick: this.handleClick}, this.props.children)
	    );
	  },
	  ...
	  render:function() {
	    return (
	      React.DOM.div({className: "navbar-top"}, 
	        React.DOM.div({className: "container"}, 
	          Link({className: "navbar-brand row", to: "/react-starter-kit/"}, 
	            React.DOM.img({src: "/react-starter-kit/images/logo-small.png", width: "38", height: "38", alt: "React"}), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	// TODO(shtylman)
	process.cwd = function () { return '/react-starter-kit/' };
